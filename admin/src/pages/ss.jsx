...
const Add_property = () => {
    ...
    const fetchData = async () => {
      try {
        const response = await axios.get(
          "https://api.yarnlink.com/api/category"
        );
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get("https://api.yarnlink.com/api/branch");
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get(
          "https://api.yarnlink.com/api/facilityCategory"
        );
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get(
          "https://api.yarnlink.com/api/commonfacility"
        );
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      await axios.post("https://api.yarnlink.com/api/property", product);
