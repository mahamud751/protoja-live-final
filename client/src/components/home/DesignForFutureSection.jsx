...
const iconClass = "w-12 h-12 text-indigo-600";
...
const Card = ({ Icon, title, description }) => (
    <div className="relative z-0 flex flex-col gap-6 rounded-3xl border-2 border-white/20 bg-gray-800 p-6 md:p-10 lg:p-12 shadow-md overflow-hidden transition">
        <div
...
const DesignForFutureSection = () => {
    return (
        <section className="max-w-7xl mx-auto px-6 lg:py-24">
            ...
            <h2 className="font-serif text-3xl md:text-5xl mt-6 text-white text-center">
