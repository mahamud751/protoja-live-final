...
export default function AboutHeroSection() {
  return (
    <motion.section
      className="relative flex flex-col items-center justify-center min-h-[80vh] bg-gradient-to-br from-[#f1f5f9] to-[#e2e8f0] text-gray-900 px-6 py-32 text-center overflow-hidden"
