...
export default function HeroSection() {
  ...
  return (
    <section className="container mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 items-center px-4 md:px-8 py-12 pt-16">
      {/* Left Content */}
      <div className="w-full">
        <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold leading-tight mb-6 text-center md:text-left bg-gradient-to-r from-[#fd5001] to-[#ff8c00] text-transparent bg-clip-text">
        ...
        <div className="flex flex-row justify-center md:justify-start gap-4 sm:gap-6 mb-12">
          <a href='#projects' className="inline-flex items-center gap-2 bg-[#fd5001] text-white px-6 h-12 rounded-full hover:rounded-2xl transition duration-200 shadow-md">
            <span className="font-semibold">Book A Call</span>
          </a>
          <a
            href="#works"
            className="group relative inline-flex items-center text-sm font-semibold text-[#fd5001] transition duration-200"
          >
            See Our Works
            ...
            <span className="absolute left-0 -bottom-0.5 w-[80%] h-0.5 bg-[#fe9667] transition-all duration-300 group-hover:w-full group-hover:bg-[#fe9667]" />
          </a>
        </div>
